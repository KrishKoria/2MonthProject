...
describe("access-control", () => {
  test("grants admin console access only to admins", () => {
  ...
  test("grants escalation resolution to senior reviewers and admins", () => {
  ...
  test("treats only assigned app roles as operational", () => {
